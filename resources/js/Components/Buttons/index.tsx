            ...
            >
                <div className="md:w-1/4 w-full mx-2 bg-gray-50 rounded-md shadow-md border border-white">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="flex flex-col items-center justify-center">
                            <div className="text-red-500 pb-2">
                                <BsDatabaseFillDash size={40} />
                            </div>
                            <div className="text-xl">Limpar Base de Dados</div>
                        </div>
                    </div>
                    <div className="my-2 flex flex-col items-center justify-center">
                        <h2 className="text-base text-center px-4">
                            Você realmente deseja limpar a base de dados {identify}?
                        </h2>
                        <h2 className="test-sm mt-1">
                            Esta operação não pode ser desfeita.
                        </h2>
