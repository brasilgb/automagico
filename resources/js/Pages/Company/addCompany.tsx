...
const AddCompany = ({ organizations }: any) => {
          ...
          <HeaderContent>
            ...
            <BreadCrumbTop
              links={[
                ...
                { url: null, label: "Adicionar filial" },
              ]}
            />
          </HeaderContent>
          <CardContainer>
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
              <CardBody className=" border-y border-gray-100">
                <div className="px-3 my-4">
                  <div className="grid md:grid-cols-7 gap-4 md:mt-6 mt-4">
                    ...
                    <div className="flex flex-col col-span-2 relative">
                      ...
                      <input
                        ...
                        className="input-form"
                        readOnly={auth.user.organization_id === null ? false : true}
                      />
